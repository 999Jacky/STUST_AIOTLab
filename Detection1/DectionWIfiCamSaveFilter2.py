...
sys.path.append("/home/xavier/models/research")
import serial
...
MODEL_NAME = '/home/xavier/train_dummies_med/new_mod_ssd'        #0511-new
# Path to frozen detection graph. This is the actual model that is used for the object detection.
PATH_TO_FROZEN_GRAPH = MODEL_NAME + '/frozen_inference_graph.pb'

# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.join('/home/xavier/train_dummies_med/data_ssd', 'object-detection.pbtxt')
# PATH_TO_LABELS = os.path.join('/home/xavier/train_dummies_med/new_mod_ssdMobileNet', 'object-detection.pbtxt')
        ...
        while (True):
            ...
            if len(QR_data) >= 1:
                ...
                while datetime.datetime.now() - t < datetime.timedelta(milliseconds=350):
                    ...
                    kernel = np.array([[0, -1, 0], [-1, 5, -1], [0, -1, 0]], np.float32) #锝化
                ...
                imgT = "output"
                cv2.imwrite("/home/xavier/img/{}_org.jpg".format(imgT), frame)
                meds = []
                meds2 = []
                ...
                cv2.imwrite("/home/xavier/img/{}.jpg".format(imgT), image_np)
